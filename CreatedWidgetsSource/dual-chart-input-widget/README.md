Dual Chart Input Widget
====================

The Chart Input Widget is a widget that can be used to define specific values from to sources for the retrieval of historic data.
