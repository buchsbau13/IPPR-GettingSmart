            ...
            onSuccess: function (response) {
                ...
                */
                ...
                /*
                    ...
                    var dataseries = responseData[0].contextElement.attributes[1].values.map(function (entry) {
                        return entry.attrValue;
                    });
                    console.log("dataseries " + dataseries);
                    var dataseriesLocation = responseData[1].contextElement.attributes[2].values.map(function (entry) {
                        return entry.attrValue;
                    });
