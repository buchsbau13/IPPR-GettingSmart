...
(function (mp) {
    ...
    var STHSource = function STHSource() {
        var attribute, entityType, entityString;
        ...
        mp.wiring.registerCallback("type", function (entityType) {
            ...
            */
            if (entityString) {
                (function loop(count) {
                    setTimeout(function () {
                        if (attribute && entityType && entityString) {
                            requestData(entityString, attribute, entityType);
                        }
                        else if (--count > 0) {
                            loop(count);
                        }
    ...
    var requestData = function requestData(entityString, attribute, entityType) {
        var entity = 'entity';
        ...
        url = new URL('v1/contextEntities/type/' + entity_type + '/id/' + entity + '/attributes/' + attribute, server);
