        ...
        */
        ...
        mp.http.makeRequest(url, {
            ...
            onSuccess: function (response) {
                ...
                var data = JSON.parse(response.responseText).contextResponses[0].contextElement;
                console.log(data);

                var responseData = JSON.parse(response.responseText).contextResponses[0].contextElement.attributes;
                ...
                var locationseries = responseData[1].values.map(function (entry) {
                    return entry.attrValue;
                });
