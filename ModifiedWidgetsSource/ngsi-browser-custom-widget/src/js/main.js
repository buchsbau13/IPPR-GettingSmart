...
/* global NGSI, StyledElements, MashupPlatform */
...
(function () {
    ...
    var DataViewer = function DataViewer() {
        ...
        MashupPlatform.prefs.registerCallback(function (newValues) {
            ...
            if ('extra_attributes' in newValues || 'type_column' in newValues || 'allow_use') {
    ...
    var createTable = function createTable() {
        ...
        if (extra_attributes !== "") {
            ...
            for (i = 0; i < extra_attributes.length; i++) {
                fields.push({
                    field: extra_attributes[i],
                    label: capitalize(extra_attributes[i]),
                    sortable: false
                });
            }
        }
